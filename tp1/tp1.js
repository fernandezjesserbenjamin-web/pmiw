...
function preload() {
  bg = loadImage("Fondohoradeaventura.png"); 
  bgMenu = loadImage("MenuHDA.png"); 
  
  animCaminar = cargarSecuencia("ZombieCaminando", 16);
  animGritar = cargarSecuencia("ZombieGritando", 10);
}
